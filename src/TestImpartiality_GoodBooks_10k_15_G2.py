...
top_items = False # True: to use GoodBooks with more ratings; False: otherwise
...
list_X_est = algorithmImpartiality.evaluate(X_est, 15) # calculates a list of 15 estimated matrices
